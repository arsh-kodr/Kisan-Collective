...
const { API_BASE, apiRoutes } = config;
...
const CreateLotModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    ...
    formData.listings.forEach((listingId) => {
      ...
      if (listing) {
        const qtyInKg =
          listing.quantityKg * (UNIT_CONVERSION[listing.unit] || 1);
        const pricePerKg =
          listing.expectedPricePerKg || listing.mandiPriceAtEntry || 0;
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-600">
                          Total: ₹
                          {(
                            bid.amount * (lot.totalQuantity || 0)
                          ).toLocaleString()}
                        </div>
                      </div>
                    </div>
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {activeTab === "overview" &&
                  "Here's your farm collective overview"}
                          ...
                          {pendingListings.map((listing) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    handleRejectListing(listing._id)
                                  }
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Create and manage your auction lots
                  </p>
                </div>
                <button
                  onClick={() => setCreateLotModal(true)}
                ...
                {loading.lots ? (
                  ...
                  <div className="p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-6">
                      Create your first auction lot to start selling
                    </p>
                    <button
                      onClick={() => setCreateLotModal(true)}
                    ...
                    {lots.map((lot) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            onClick={() =>
                              setLotDetailsModal({ isOpen: true, lot })
                            }
